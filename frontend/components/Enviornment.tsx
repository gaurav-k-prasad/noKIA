...
export default function EnvironmentModule() {
  ...
  // Formatting the date and time (Military/Tactical style)
  ...
  return (
    <div className="flex flex-col bg-slate-900 border-2 border-slate-700 rounded-lg overflow-hidden font-mono text-sm shadow-lg w-full max-w-sm">
      {/* Header */}
